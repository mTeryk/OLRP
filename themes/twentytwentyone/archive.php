...
<?php if ( have_posts() ) : ?>
	...
	<div class="olrp_resource_archive">  <table class="olrp_display_table display compact" style="width:100%"><thead><th>Title</th><th>URL</th><th>Creator</th><th>Summary</th><th>Tags</th><th>More Info</th></thead>
		...
		<?php while ( have_posts() ) : ?>
			...
			$creator = $meta['olrp-resource-creator'][0];
			...
			$output .= "<tr>";
			$output .= "<td><a target=\"_blank\" href=\" $url \"> $title </a></td>";
			$output .= "<td>$url</td>";
