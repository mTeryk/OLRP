<?php
	...
	/**
	 * Most Bookmarked downloads(Easy Digital Downloads) widget for vc
	 *
	 * Class CBXWPBookmarkDownlods_VCWidget
	 */
	class CBXWPBookmarkDownlods_VCWidget extends WPBakeryShortCode {
		/**
		 * Constructor.
		 */
		...
		public function bakery_shortcode_mapping() {
			...
			vc_map( array(
				"name"        => esc_html__( "CBX Most Bookmarked Downloads List", 'cbxwpbookmarkaddon' ),
				"description" => esc_html__( "This widget shows most bookmarked downloads(EDD) within specific time limit.", 'cbxwpbookmarkaddon' ),
				"base"        => 'cbxwpbookmark-mostdownloads',
				"icon"        => CBXWPBOOKMARKADDON_ROOT_URL . 'assets/img/widget_icons/icon_most_downloads.png',
				...
				"params"      => array(
					array(
						...
						"param_name"  => "title",
						"std"         => esc_html__('Most Bookmarked Products', 'cbxwpbookmarkaddon'),
					),
					array(
						"type"        => "dropdown",
						'admin_label' => true,
					...
					array(
						"type"        => "dropdown",
						'admin_label' => true,
						"heading"     => esc_html__( "Show price", 'cbxwpbookmarkaddon' ),
					...
					array(
						"type"        => "dropdown",
						'admin_label' => true,
						"heading"     => esc_html__( "Show cart", 'cbxwpbookmarkaddon' ),
						"param_name"  => "show_addcart",
						'value'       => array(
							esc_html__( 'Yes', 'cbxwpbookmarkaddon' ) => 1,
							esc_html__( 'No', 'cbxwpbookmarkaddon' ) => 0,
						),
	...
	}// end class CBXWPBookmarkDownlods_VCWidget