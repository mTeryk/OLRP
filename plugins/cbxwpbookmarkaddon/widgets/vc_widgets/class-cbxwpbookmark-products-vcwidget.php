<?php
	...
	/**
	 * Most Bookmarked products grid widget for vc
	 *
	 * Class CBXWPBookmarkProducts_VCWidget
	 */
	class CBXWPBookmarkProducts_VCWidget extends WPBakeryShortCode {
		/**
		 * Constructor.
		 */
		...
		public function bakery_shortcode_mapping() {
			...
			vc_map( array(
				"name"        => esc_html__( "CBX Most Bookmarked Products List", 'cbxwpbookmarkaddon' ),
				"description" => esc_html__( "This widget shows most bookmarked products(WOO) within specific time limit.", 'cbxwpbookmarkaddon' ),
				"base"        => 'cbxwpbookmark-mostproducts',
				"icon"        => CBXWPBOOKMARKADDON_ROOT_URL . 'assets/img/widget_icons/icon_most_products.png',
	...
	}// end class CBXWPBookmarkProducts_VCWidget