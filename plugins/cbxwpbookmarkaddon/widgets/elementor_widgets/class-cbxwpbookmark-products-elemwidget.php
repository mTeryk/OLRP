<?php
	...
	/**
	 * Most bookmarked products(Woocommerce Products) Elementor Widget
	 */
	class CBXWPBookmarkProducts_ElemWidget extends \Elementor\Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'CBX Most Bookmarked Products List', 'cbxwpbookmarkaddon' );
		}
		...
		public function get_icon() {
			return 'cbxwpbookmars-most-products-icon';
		}
		...
		protected function _register_controls() {
			...
			$this->start_controls_section(
				'section_cbxwpbookmarkproducts',
				array(
					'label' => esc_html__( 'Most Bookmarked Products Setting', 'cbxwpbookmarkaddon' ),
				)
			);
		...
		protected function render() {
			...
			$attr = apply_filters( 'cbxwpbookmark_elementor_shortcode_builder_attr', $attr, $settings, 'cbxwpbookmark-mostproducts' );
			...
			echo do_shortcode( '[cbxwpbookmark-mostproducts ' . $attr_html . ']' );
		}//end method render
	...
	}//end method CBXWPBookmarkProducts_ElemWidget
