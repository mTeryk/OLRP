...
class WPBM_Products extends WP_Widget {
	 ...
	 * @var      string
	 */
	protected $widget_slug = 'cbxwpbmmostproduct-widget';
	...
	public function __construct() {
		parent::__construct( $this->get_widget_slug(), esc_html__( 'CBX Most Bookmarked Products List', "cbxwpbookmarkaddon" ), array(
				'classname'   => 'cbxwpbookmark-mostlist-wrap cbxwpbookmark-mostlist-wrap-products cbxwpbookmark-mostlist-wrap-widget ' . $this->get_widget_slug() . '-class',
				'description' => esc_html__( 'This widget shows most bookmarked products within specific time limit.', "cbxwpbookmarkaddon" )
			)
		);

		//Refreshing the widget's cached output with each new post
		//add_action( 'save_post', array( $this, 'flush_widget_cache' ) );
		add_action( 'save_post_product', array( $this, 'flush_widget_cache' ) );
	...
	public function widget( $args, $instance ) {
		...
		// Title
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Most Bookmarked Products', 'cbxwpbookmarkaddon' ) : $instance['title'], $instance, $this->id_base );
		...
		$instance['title'] = '';
		$widget_string     .= cbxwpbookmarkpro_get_template_html( 'widgets/wpbmproducts-widget.php', array( 'instance' => $instance, 'ref' => $this ) );
