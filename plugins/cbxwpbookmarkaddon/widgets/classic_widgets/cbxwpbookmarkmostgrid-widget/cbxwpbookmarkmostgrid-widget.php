...
/**
 * Class CBXWPBookmarkedMostGrid_Widget
 */
class CBXWPBookmarkedMostGrid_Widget extends WP_Widget {
	 ...
	 * @var      string
	 */
	protected $widget_slug = 'cbxwpbookmarkedmostgrid-widget';
	...
	public function __construct() {
		parent::__construct(
			$this->get_widget_slug(), esc_html__( 'CBX Most Bookmarked Posts Grid', "cbxwpbookmarkaddon" ), array(
				'classname'   => 'cbxbookmark_cards_wrapper_mostgrid-wrap cbxbookmark_cards_wrapper_mostgrid-wrap-widget ' . $this->get_widget_slug() . '-class',
	...
	public function widget( $args, $instance ) {
		...
		// Title
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Most Bookmarked Posts', 'cbxwpbookmarkaddon' ) : $instance['title'], $instance, $this->id_base );
		...
		$attr['load_more']  = isset($instance['load_more'])? absint( $instance['load_more'] ) : 0;

		$attr = apply_filters( 'cbxwpbookmark_widget_shortcode_builder_attr', $attr, $instance, 'cbxwpbookmark-mostgrid' );
		...
		$widget_string .= do_shortcode( '[cbxwpbookmark-mostgrid ' . $attr_html . ']' );
	...
	public function form( $instance ) {
		$instance = wp_parse_args(
			(array) $instance,
			array(
				'title'      => esc_html__( 'Most Bookmarked Posts', 'cbxwpbookmarkaddon' ),
				'limit'      => 10,
				'daytime'    => '0',
...
}//end class CBXWPBookmarkedMostGrid_Widget