...
== Changelog ==
= 1.7.5 =
* [fixed] When frontend category creation privacy hidden or set from dashboard category save buttons doesn't show

= 1.7.4 =
* [fixed] Category name display backward slash issue solved
* [proaddon] there is update in pro addon, pls upgrade

= 1.7.3 =
* [fixed] Activation error correction for version 1.7.2
...
= 1.7.0 =
* [new] Delete all bookmark  param in my bookmarks, my bookmarks grid shortcodes, elementor widgets, vc widgets
* [proaddon] there is update in pro addon, pls upgrade
...
= 1.6.12 =
* [improvement] auto integration is disabled in dashboard if 'the_content' is fired in dashboard somehow
* [proaddon] there is update in pro addon, pls upgrade

= 1.6.11 =
* [improvement] added object id or post id in bookmark listing table in plugin dashboard for easy understanding

= 1.6.10 =
* [fixed] select2 library loaded perfectly in all widgets and places.

= 1.6.9 =
* [improvement] $_REQUEST['page'] escaped with esc_url , issue pointed by wpscan.com


= 1.6.8 =

* [improvement] Bookmark popup screen refreshed with better ui
* [improvement] More dashboard  setting ui/ux improvements
* [new] Z-index for bookmark popup so that it's easy to fix for any theme
* [improvement] Other minor improvements
* [new] New features in pro addon. New buddypress setting tab addedin plugin setting, please check and save once again.
