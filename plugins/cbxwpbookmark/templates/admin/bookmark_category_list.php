...
<div class="wrap">
    ...
    <p><?php echo '<a class="button button-primary button-large" href="' . admin_url( 'admin.php?page=cbxwpbookmarkcats&view=edit&id=0' ) . '">' . esc_html__( 'Create New Resource List', 'cbxwpbookmark' ) . '</a>'; ?></p>
