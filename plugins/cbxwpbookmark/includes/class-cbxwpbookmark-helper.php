...
class CBXWPBookmarkHelper {
		...
		if ( $user_id == 0 ):
			...
			if ( $bookmark_mode != 'no_cat' ):
				$cbxwpbkmark .= ' <div style="z-index: '.$pop_z_index.';"  data-type="' . $object_type . '" data-object_id="' . $object_id . '" class="cbxwpbkmarklistwrap" id="cbxwpbkmarklistwrap-' . $object_id . '">
                             <span class="addto-head"><i class="cbxwpbkmarktrig_label">' . esc_html__( 'Click Resource List to Bookmark', 'cbxwpbookmark' ) . '</i><i title="' . esc_html__( 'Click to close bookmark panel', 'cbxwpbookmark' ) . '"  data-object_id="' . $object_id . '" class="cbxwpbkmarktrig_close"></i></span>
				...
				if ( $bookmark_mode == 'user_cat' ) :
					...
					$cbxwpbkmark .= '
                                    ...
                                    <div class="cbxwpbkmark-field-wrap">                                                                               
                                        <div class="cbxwpbkmarkaddnewcatselect ' . $cat_hide_class . '">
                                          <select class="cbxwpbkmark-field cbxwpbkmark-field-select  cbxwpbkmark-field-privacy cbxwpbkmark-field-privacy_' . $object_id . '">
                                          	<option ' . selected( $category_default_status, 1, false ) . ' value="1">' . esc_html__( 'Public Resource List', 'cbxwpbookmark' ) . '</option>
                                          	<option ' . selected( $category_default_status, 0, false ) . ' value="0">' . esc_html__( 'Private Resource List', 'cbxwpbookmark' ) . '</option>
										  </select>                                          
                                        </div>
                                ...
                                <div class="cbxwpbkmark_cat_edit_form">
                                    ...
                                    <div class="cbxwpbkmark-field-wrap">                                        
                                        <div class="cbxwpbkmarkmanagecatselect ' . $cat_hide_class . '">
                                        	<select class="cbxwpbkmark-field cbxwpbkmark-field-select  cbxwpbkmark-field-privacy cbxwpbkmark-field-privacy_' . $object_id . '">
	                                            <option value="1">' . esc_html__( 'Public Resource List', 'cbxwpbookmark' ) . '</option>
	                                            <option value="0">' . esc_html__( 'Private Resource List', 'cbxwpbookmark' ) . '</option>
										  	</select>                                          
                                        </div>
								...
								<div class="cbxwpbkmark-toolbar">
									<span class="cbxwpbkmark-toolbar-newcat" data-type="' . $object_type . '" data-object_id="' . $object_id . '" >' . esc_html__( 'New Resource List', 'cbxwpbookmark' ) . '</span>
									<span class="cbxwpbkmark-toolbar-listcat" data-type="' . $object_type . '" data-object_id="' . $object_id . '" >' . esc_html__( 'List Lists', 'cbxwpbookmark' ) . '</span>
									<span class="cbxwpbkmark-toolbar-editcat" data-type="' . $object_type . '" data-object_id="' . $object_id . '" >' . esc_html__( 'Manage Lists', 'cbxwpbookmark' ) . '</span>
									<div class="cbxwpbkmark-clearfix"></div>									
	...
	public static function create_category_html( $instance = array() ) {
		...
		if ( intval( $instance['allowedit'] ) && $bookmark_mode == 'user_cat' ) {
			...
			$create_category_html .= '<span class="cbxbookmark-category-list-create">' . esc_html__( 'Create New Resource List', 'cbxwpbookmark' ) . '</span>';
			...
			$create_category_html .= '<div class="cbxbookmark-mycat-editbox">
                ...
                <select class="cbxbmedit-privacy input-catprivacy  ' . $cat_hide_class . '" name="catprivacy">
                  <option ' . selected( $category_default_status, 1, false ) . ' value="1" title="Public Resource List">' . esc_html__( 'Public', 'cbxwpbookmark' ) . '</option>
                  <option ' . selected( $category_default_status, 0, false ) . ' value="0" title="Private Resource List">' . esc_html__( 'Private', 'cbxwpbookmark' ) . '</option>
                </select>
